  ...
  <body bgcolor="#f7f8f7">
    ...
    <s:iterator value="examinees">
    	<tr align="center" class="tr">
    		...
    		<td><s:property value="sex"/></td>
  			<td><s:property value="examineeOfSchool"/></td>
  			...
  			<td><a href="<%=request.getContextPath() %>/cet4/examineeAction-getExamineeByCandidateNo?candidateNo=${candidateNo}">修改</a></td>
  		</tr>
    </s:iterator>
    </table>
    <table width="100%" align="center" cellspacing="0">
    	<tr align="center" bgcolor="#dcedf7">
    		<td>
			    <a href="<%=request.getContextPath() %>/cet4/examineeAction-linkUpdateExamineePage?curPage=1">【首页】</a>
			    <c:if test="${curPage>1}">
			    	<a href="<%=request.getContextPath() %>/cet4/examineeAction-linkUpdateExamineePage?curPage=${curPage-1}">【上一页】</a>
			    </c:if>
			    <c:if test="${curPage<maxPage}">
			    	<a href="<%=request.getContextPath() %>/cet4/examineeAction-linkUpdateExamineePage?curPage=${curPage+1}">【下一页】</a>
			    </c:if>
			    <a href="<%=request.getContextPath() %>/cet4/examineeAction-linkUpdateExamineePage?curPage=${maxPage}">【尾页】</a>&nbsp;&nbsp;&nbsp;&nbsp;
    		</td>
    		<td style="padding-top: 15px;">
			    <form action="<%=request.getContextPath() %>/cet4/examineeAction-linkUpdateExamineePage" name="page" onsubmit="return check()">   
