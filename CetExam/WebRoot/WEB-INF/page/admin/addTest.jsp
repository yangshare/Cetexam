...
.file {
	...
	<body bgcolor="#f7f8f7" style="border: 2px solid #ccccff;">
		<center>
			<br />
			<font size="5" face="华文行楷"> <a href="javascript:void(0)"
				...
				<a href="javascript:void(0)"
				onclick="document.getElementById('close').scrollIntoView();">翻译</a>
			</font>
		</center>
		<br />
		<hr />
		...
		<s:iterator value="testnames" begin="0" end="0">
			<s:form action="updateTest-addTestName" namespace="/cet4"
				method="post">
		...
		<s:iterator value="compositions" begin="0" end="0">
			<s:form action="updateTest-addComposition" namespace="/cet4"
				method="post">
		...
		<s:iterator value="titlesofreadings" begin="0" end="0">
			<s:form action="updateTest-addTitlesofreading" namespace="/cet4"
				method="post">
		...
		<s:iterator value="optionsofreadings" begin="0" end="9">
			<s:form action="updateTest-addOptionsofreading" namespace="/cet4"
				method="post">
		...
		<s:iterator value="listeningmaterials" begin="0" end="0">
			<s:form action="updateTest-addLsteningmaterial" namespace="/cet4"
		...
		<s:iterator value="optionoflistenings" begin="0" end="24">
			<s:form action="updateTest-addOptionoflistening" namespace="/cet4"
				method="post">
		...
		<s:iterator value="compoundchoosewords" begin="0" end="10">
			<s:form action="updateTest-addCompoundchoosewords" namespace="/cet4"
				method="post">
				<table width="100%" cellspacing="0">
					<tr height="50px">
						<td>
		...
		<s:iterator value="translates">
			<s:form action="updateTest-addTranslate" namespace="/cet4"
				method="post">
