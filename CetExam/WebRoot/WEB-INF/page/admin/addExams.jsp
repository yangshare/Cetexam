...
<html>
  ...
  <body bgcolor="#f7f8f7">
    ...
    <form action="<%=request.getContextPath() %>/cet4/examAction-add" method="post" name="addExaminee"  onsubmit="return check()">
    	<table height="40%">
    		<tr>
    		...
    		<tr>
    			...
    			<td>
    				<input name="time" placeholder="2016/6/18 00:00:00"><label>*格式如：2016/6/18 00:00:00</label>
    			</td>
    		</tr>
    		<tr>
    			<td><font size="4">考号区间：</font></td>
    			<td><input name="numarea"><label>*格式如：10-100</label></td>
    		</tr>
    		<tr>
    			<td><font size="4">监考老师：</font></td>
    			<td><input name="testteachers"/></td>
    		</tr>
    		<tr>
